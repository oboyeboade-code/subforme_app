...
export const VendorController = {
    ...
    async me(req, res, next) {
        try {
            ...
            if (!business)
                throw new AppError("Vendor business not found for user", 404);
    ...
    async redeem(req, res, next) {
        try {
            ...
            if (!servCode || !authCode)
                throw new AppError("servCode and authCode are required", 400);
...
//# sourceMappingURL=vendorBusiness.controller.js.map